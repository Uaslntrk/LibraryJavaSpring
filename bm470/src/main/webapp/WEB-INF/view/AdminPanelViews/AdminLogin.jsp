    ...
    <div class="col-md-6 form-side">
        ...
        <form method="POST" action="${pageContext.request.contextPath}/admin/adminlogin">
            <div class="form-group">
                ...
                <input type="text" name="tckn" id="tckn" class="form-control" placeholder="${loginTckn}" required maxlength="11" pattern="^\d{11}$" title="${registerTCKNError}">
            </div>
            <div class="form-group">
                <i class="fas fa-lock form-icon"></i>
                <input type="password" name="password" id="password" class="form-control" placeholder="${loginPassword}" required minlength="6"  title="${registerPasswordError}">
            </div>
            <div class="d-grid">
