...
<div class="container my-5">
    <h2 class="mb-4">${returnedTitle}</h2>
    <p class="text-muted">${returnedInfo}</p>
                            ...
                            <div class="col">
                                <div class="card h-100 shadow-sm">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <p class="card-text mb-3"><strong>${returnedDate}</strong> ${rental.returnDate}</p>

                                        <div class="mt-auto">
                                            <span class="badge bg-secondary"><i class="bi bi-check-circle"></i>${returnedReturned}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
